...
public class BackgroundRenderer {
     ...
     */
    public void render(Graphics graphics, Player mainPlayer, BoundingBoxBorder border, GameWindowRenderer observer) {
        ...
        graphics.drawImage(backgroundImage, backGroundX, backGroundY, (int)backgroundWidth, (int) backgroundHeight, observer.getWindow());
    }
}
