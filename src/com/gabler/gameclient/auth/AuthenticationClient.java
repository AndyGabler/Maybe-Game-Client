...
public class AuthenticationClient extends ClientConfiguration {
    ...
    private final Consumer<String> sessionSecretConsumer;

    public AuthenticationClient(Consumer<String> aSessionSecretConsumer) {
        sessionSecretConsumer = aSessionSecretConsumer;
    }
